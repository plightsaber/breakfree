  ...
  if ((tmpAction == llList2String(struggle_puzzle,struggle_progress))) {
    ...
    if ((struggle_progress >= llGetListLength(struggle_puzzle))) {
      ...
      if ((!assisted())) {
        ...
        if ((activePart == "arm")) {
          simpleRequest("addExp",((string)arm_difficulty));
        }
        if ((activePart == "leg")) {
          simpleRequest("addExp",((string)leg_difficulty));
        }
        if ((activePart == "gag")) {
    ...
    if (((!assisted()) && (struggle_progress > 0))) {
      (struggle_progress--);
    }
  }
  if ((!assisted())) {
...
default {
  ...
  link_message(integer prmLink,integer prmValue,string prmText,key prmID) {
    ...
    if ((function == "setGender")) {
      ...
      integer screen = 0;
      if ((((integer)llJsonGetValue(prmText,["restorescreen"])) && guiScreen)) {
        (screen = guiScreen);
      }
      init(userkey,screen);
    }
