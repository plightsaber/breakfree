...
addDex(string prmValue) {
    ...
    if (addValue > 0) { dex += addValue; }
} 
addInt(string prmValue) {
    integer addValue = (integer)prmValue;
    if (addValue > 0) { int += addValue; }
} 
addStr(string prmValue) {
    integer addValue = (integer)prmValue;
    if (addValue > 0) { str += addValue; }
}
addExp(string prmValue) {
    integer addValue = (integer)prmValue;
    if (addValue > 0) { exp += addValue; }
}
...
setDex(string prmValue) {
    ...
    if (setValue > 0) { dex = setValue; }
} 
setInt(string prmValue) {
    integer setValue = (integer)prmValue;
    if (setValue > 0) { int = setValue; }
} 
setStr(string prmValue) {
    integer setValue = (integer)prmValue;
    if (setValue > 0) { str = setValue; }
}
setExp(string prmValue) {
    integer setValue = (integer)prmValue;
    if (setValue > 0) { exp = setValue; }
}
...
default {
    ...
    state_entry() { init(); }
     ...
     link_message(integer prmLink, integer prmValue, string prmText, key prmID) {
        ...
        if (function == "addDex") { addDex(value); }
        else if (function == "addStr") { addStr(value);  }
        else if (function == "addInt") { addInt(value);  }
        else if (function == "addSkill") { addSkill(value);  }
        else if (function == "addExp") { addExp(value); }
        else if (function == "addSkill") { addSkill(value);  }
        
        else if (function == "setDex") { setDex(value); }
        else if (function == "setStr") { setStr(value);  }
        else if (function == "setInt") { setInt(value);  }
        else if (function == "setExp") { setExp(value); }
        else if (function == "setSkills") { setSkills(value); }
    }
}
