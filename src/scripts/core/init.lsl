...
touchUser(string prmUserObj){
  ...
  if (isBound()) {
    if ((rpMode || ((!toucherBound) && (toucherID == villainID)))) {
...
bindArms(string prmInfo){
  (armsBound = ((prmInfo != "free") && (prmInfo != "external")));
}
...
default {
    ...
    else  if ((function == "setRPMode")) {
      (rpMode = ((integer)value));
    }
